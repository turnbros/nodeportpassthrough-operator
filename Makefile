...
# turnbros.app/nodeportpassthrough-operator-bundle:$VERSION and turnbros.app/nodeportpassthrough-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= turnbros.app/nodeportpassthrough-operator
